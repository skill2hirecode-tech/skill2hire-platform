...
export const metadata: Metadata = {
  ...
  description:
    "Learn about how Skill2Hire Technologies uses cookies and similar technologies.",
};
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-8 md:p-12">
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 leading-relaxed">
              This Cookie Policy explains how Skill2Hire Technologies ("we,"
            ...
            <div className="space-y-6">
              ...
              <div className="border-l-4 border-primary bg-gray-50 p-4 rounded-r-lg">
                ...
                <p className="text-gray-700 text-sm mt-3 italic">
                  <strong>Note:</strong> These cookies cannot be disabled as
                  they are essential for the website to work.
                </p>
              </div>
              ...
              <div className="border-l-4 border-secondary bg-gray-50 p-4 rounded-r-lg">
                ...
                <p className="text-gray-700 text-sm mt-3">
                  <strong>Third-party services:</strong> Facebook Pixel,
                  LinkedIn Insights
                </p>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <h3 className="text-xl font-semibold text-navy mb-3 mt-6">
              4.1 Session Cookies
            </h3>
            <p className="text-gray-700 leading-relaxed mb-4">
              These are temporary cookies that expire when you close your
              browser. They are used to maintain your session while you navigate
              the website.
            </p>
            ...
            <p className="text-gray-700 leading-relaxed">
              These cookies remain on your device for a set period (ranging from
              days to years) or until you manually delete them. They remember
          ...
          <section className="mb-10">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <ul className="space-y-3 text-gray-700">
                ...
                <li>
                  <strong>Facebook Pixel:</strong> Tracks conversions and
                ...
                <li>
                  <strong>LinkedIn Insights:</strong> Analyzes professional
                  audience engagement
                  <br />
                  <a
          ...
          <section className="mb-10">
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mt-6 rounded-r-lg">
              <p className="text-gray-700 text-sm">
                <strong>⚠️ Important:</strong> Blocking or deleting cookies may
                affect your ability to use certain features of our website, such
                as staying logged in or saving your preferences.
              </p>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              is no industry standard for how to respond to DNT signals. We do
              not currently respond to DNT signals, but we respect your privacy
              choices through our cookie consent banner.
            </p>
          </section>
