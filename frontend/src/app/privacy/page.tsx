...
export const metadata: Metadata = {
  ...
  description:
    "Learn how Skill2Hire Technologies collects, uses, and protects your personal information.",
};
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-8 md:p-12">
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Welcome to Skill2Hire Technologies ("we," "our," or "us"). We are
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
              <li>
                <strong>Job Recruitment:</strong> To process job applications
                and match candidates with suitable positions
              </li>
              <li>
                <strong>Training Services:</strong> To manage course enrollments
              ...
              <li>
                <strong>Marketing:</strong> To send newsletters and promotional
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
              <li>
                <strong>With Employers:</strong> When you apply for jobs, we
                share your application details with potential employers
              </li>
              <li>
                <strong>Service Providers:</strong> With third-party vendors who
                help us operate our platform (e.g., email services, hosting)
              </li>
              <li>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 leading-relaxed mt-4">
              ...
              >
                privacy@skill2hiretechnologies.com
              </a>
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              ...
              browsing experience. For detailed information about our cookie
          ...
          <section className="mb-10">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              longer retention period is required by law. Job applications and
              resumes are typically retained for 2 years, while course
              enrollment data is kept for the duration of the course plus 1
              year.
            </p>
          </section>
